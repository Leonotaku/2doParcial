...
#define TetrisUSFX01_master_Source_TetrisUSFX01_Board_h_15_PRIVATE_PROPERTY_OFFSET \
	FORCEINLINE static uint32 __PPO__BuilderPiezaDorada() { return STRUCT_OFFSET(ABoard, BuilderPiezaDorada); } \
	FORCEINLINE static uint32 __PPO__BuilderPiezaBronze() { return STRUCT_OFFSET(ABoard, BuilderPiezaBronze); } \
	FORCEINLINE static uint32 __PPO__BuilderPiezaPlata() { return STRUCT_OFFSET(ABoard, BuilderPiezaPlata); } \
	FORCEINLINE static uint32 __PPO__BuilderPiezaDiamante() { return STRUCT_OFFSET(ABoard, BuilderPiezaDiamante); } \
	FORCEINLINE static uint32 __PPO__DirectorPiezas() { return STRUCT_OFFSET(ABoard, DirectorPiezas); }
