...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SpawnedPiezaBasica_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SpawnedPiezaBasica;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATetrisUSFX01GameModeBase_DestroyActorFunction, "DestroyActorFunction" }, // 2821715988
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedPiezaBasica_MetaData[] = {
		{ "ModuleRelativePath", "TetrisUSFX01GameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedPiezaBasica = { "SpawnedPiezaBasica", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATetrisUSFX01GameModeBase, SpawnedPiezaBasica), Z_Construct_UClass_APiezaBasica_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedPiezaBasica_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedPiezaBasica_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Inventory_MetaData[] = {
		{ "ModuleRelativePath", "TetrisUSFX01GameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Inventory = { "Inventory", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATetrisUSFX01GameModeBase, Inventory), Z_Construct_UClass_ABoard_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Inventory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Inventory_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_SpawnedPiezaBasica,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATetrisUSFX01GameModeBase_Statics::NewProp_Inventory,
	};
	...
	IMPLEMENT_CLASS(ATetrisUSFX01GameModeBase, 4213204982);
