...
private:
	...
	IEstadoEscenario* EstadoPasado;
	IEstadoEscenario* EstadoPresente;
	IEstadoEscenario* EstadoFuturo;
...
public:
	...
	IEstadoEscenario* getEstadoPasado();
	IEstadoEscenario* getEstadoPresente();
	IEstadoEscenario* getEstadoFuturo();
